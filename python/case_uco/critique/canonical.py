"""Canonical graph view — vendored from mcp_server/critic/canonical.py.

Construction critique uses this copy so the wheel does not import mcp_server.
Keep IRI expansion and node indexing aligned with the MCP critic so ported
CRIT-H-* finding IDs can match analyze_artifact.
